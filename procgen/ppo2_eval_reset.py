...
from procgen.policy_new import build_policy_sample, build_policy_reset, build_policy_aug
    ...
    **network_kwargs:                 keyword arguments to the policy / network builder. See baselines.common/policies.py/build_policy and arguments to a particular type of network
    ...
    if data_aug is not None:
            aug_to_func = {    
                ...
                'crop':rad.Rand_Crop,
                #'salt':tf_util.fun1,
                #'gaussian':tf_util.gaussiannoise
                }
            augs_funcs = aug_to_func[data_aug](batch_size=nenvs)
            obs[:] = augs_funcs.do_augmentation(obs)
            
            #img1=fun1(obs[0],0.2)
            #img1=gaussiannoise(obs[0],2,4,0.5)
            #Write a noisy image named PepperandSalt.jpg in the folder
