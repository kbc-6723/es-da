...
class CoinRun : public BasicAbstractGame {
  public:
    ...
    void load_background_images() override {
        ...
        else if (options.distribution_mode == EasyplusMode)
            main_bg_images_ptr = &platform_backgrounds_test;
        else main_bg_images_ptr = &platform_backgrounds; 
    ...
    void game_reset() override {
        ...
        if (options.distribution_mode == EasyMode) {
            ...
            agent->image_theme = 0;
            wall_theme = 0;
            background_index = rand()%49;
        }
        else if(options.distribution_mode == HardminusMode){
            agent->image_theme = 0;
            wall_theme = 0;
            background_index = 0;
        }
