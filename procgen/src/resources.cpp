...
std::vector<std::shared_ptr<QImage>> topdown_backgrounds_test;
...
std::vector<std::shared_ptr<QImage>> space_backgrounds_test;
std::vector<std::shared_ptr<QImage>> water_backgrounds;
std::vector<std::shared_ptr<QImage>> water_backgrounds_test;
std::vector<std::shared_ptr<QImage>> water_surface_backgrounds;
std::vector<std::shared_ptr<QImage>> water_surface_backgrounds_test;
...
void images_load() {
    ...
    auto group_to_vector = std::map<std::string, std::vector<std::shared_ptr<QImage>> *>{
        ...
        {"space_backgrounds_test", &space_backgrounds_test},
        ...
        {"topdown_backgrounds_test", &topdown_backgrounds_test},        
        {"topdown_simple_backgrounds", &topdown_simple_backgrounds},
        {"water_backgrounds", &water_backgrounds},
        {"water_backgrounds_test", &water_backgrounds_test},
        {"water_surface_backgrounds", &water_surface_backgrounds},
        {"water_surface_backgrounds_test", &water_surface_backgrounds_test},
    };
    ...
    auto group_to_paths = std::map<std::string, std::vector<std::string>>{
        ...
        {
            "water_surface_backgrounds_test",
            {
                "water_backgrounds/water2.png",
                "water_backgrounds/water3.png",
                "water_backgrounds/water4.png",
