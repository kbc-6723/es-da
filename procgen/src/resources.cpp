...
std::vector<std::shared_ptr<QImage>> platform_backgrounds_train;
std::vector<std::shared_ptr<QImage>> platform_backgrounds_test;
std::vector<std::shared_ptr<QImage>> space_backgrounds;
std::vector<std::shared_ptr<QImage>> water_backgrounds;
std::vector<std::shared_ptr<QImage>> water_backgrounds1;
std::vector<std::shared_ptr<QImage>> water_backgrounds2;
std::vector<std::shared_ptr<QImage>> water_backgrounds3;
...
void images_load() {
    auto group_to_vector = std::map<std::string, std::vector<std::shared_ptr<QImage>> *>{
        ...
        {"platform_backgrounds_train", &platform_backgrounds_train},
        {"platform_backgrounds_test", &platform_backgrounds_test},
        ...
        {"water_backgrounds1", &water_backgrounds1},
        {"water_backgrounds2", &water_backgrounds2},
        {"water_backgrounds3", &water_backgrounds3},
