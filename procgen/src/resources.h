...
extern std::vector<std::shared_ptr<QImage>> topdown_backgrounds_test;
...
extern std::vector<std::shared_ptr<QImage>> platform_backgrounds_test;
extern std::vector<std::shared_ptr<QImage>> space_backgrounds;
extern std::vector<std::shared_ptr<QImage>> space_backgrounds_test;
extern std::vector<std::shared_ptr<QImage>> water_backgrounds;
extern std::vector<std::shared_ptr<QImage>> water_backgrounds_test;
extern std::vector<std::shared_ptr<QImage>> water_surface_backgrounds;
extern std::vector<std::shared_ptr<QImage>> water_surface_backgrounds_test;