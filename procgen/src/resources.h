...
extern std::vector<std::shared_ptr<QImage>> platform_backgrounds_train;
...
extern std::vector<std::shared_ptr<QImage>> water_backgrounds1;
extern std::vector<std::shared_ptr<QImage>> water_backgrounds2;
extern std::vector<std::shared_ptr<QImage>> water_backgrounds3;
