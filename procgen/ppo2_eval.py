...
def learn(*, network, env, total_timesteps, eval_env = None,data_aug=None, seed=None, nsteps=2048, ent_coef=0.0, lr=3e-4, id = None,rep_count=1,
    ...
    **network_kwargs:                 keyword arguments to the policy / network builder. See baselines.common/policies.py/build_policy and arguments to a particular type of network
    ...
    if data_aug is not None:
            ...
            augs_funcs = aug_to_func[data_aug](batch_size=nenvs,brightness=0.1,                              
                 contrast=0.1,
                 saturation=0.1, 
                 hue=0.1, p_gray=0.5)
