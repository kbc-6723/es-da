...
class Model(object):
    ...
    def __init__(self, *, policy, ob_space, ac_space, nbatch_act, nbatch_train, 
        ...
        self.reset_loss_names = ['l2_loss', 'pi_l2_loss','vf_loss', 'impala_network_size']
        self.reset_stats_list = [reset_loss, pi_l2_loss, vf_loss, l2_weight] #reset
