...
class CategoricalPdType(PdType):
    ...
    def pdfromlatent_sample(self,  latent_vector,na, init_scale=1.0, init_bias=0.0):
        pdparam = _matching_fc(latent_vector, na,  self.ncat, init_scale=init_scale, init_bias=init_bias)
        return self.pdfromflat(pdparam), pdparam
