...
class Runner(AbstractEnvRunner):
    ...
    - Make a mini batch
    """
    def __init__(self, *, env, model, nsteps, gamma, lam, eval_flag=False):
        ...
        self.aug_func_cj = rad.ColorJitterLayer(env.num_envs)
        self.aug_func_gr = rad.RandGray(env.num_envs)
        self.aug_func_cc = rad.Center_Crop(env.num_envs)
    def run(self):
        ...
        last_values = np.concatenate((last_values,last_values),axis=0)
