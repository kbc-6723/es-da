...
LOG_DIR = '/home/postech/procgen/' #checkpoint location
...
def main():
    ...
    venv = ProcgenEnv(num_envs=num_eval, env_name=env_name, num_levels=num_levels, start_level=start_level, distribution_mode=distribution_mode)
