...
class Model(object):
    ...
    def __init__(self, *, policy, ob_space, ac_space, nbatch_act, nbatch_train, 
        ...
        params = [v for v in total_params if 'new_impala' in v.name] #srat
        ...
        weight_params_policy_fc = [v for v in total_params if ('pi' in v.name) and ('Adam' not in v.name)]
        weight_params_value_fc = [v for v in total_params if ('vf' in v.name) and ('Adam' not in v.name)]
        print(params)
